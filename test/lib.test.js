...
test("should return list of dog names, breeds, ages and URLs", () => {
    ...
    expect(dogs).toEqual(expect.arrayContaining([
        { name: "CASPER", breed: "greyhound", age: "3 Years", url: "https://www.battersea.org.uk/dogs/dog-rehoming-gallery/casper" },
        { name: "IVAN", breed: "lurcher", age: "4 Years, 2 Months", url: "https://www.battersea.org.uk/dogs/dog-rehoming-gallery/ivan" }
    ]));
})
